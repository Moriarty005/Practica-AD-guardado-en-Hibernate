 ...
 /*                                                                        MÉTODOS DE MODIFICACIÓN DE LAS ÁREAS DE INSERCIÓN                                                                      */
    ...
    public void agregarCocinerosAModelo(){
        ...
        for(int index = 0; index < this.controller.lista_cocineros.size(); index++){
            ...
            this.modelo_cocineros.addElement(this.controller.getCocineroAtPosition(index).getNombreCocinero());
        }
    }
    ...
    public void agregarTodosLosPlatosACombobox(){
        ...
        for(int index = 0; index < this.controller.lista_de_platos.size(); index++){
            ...
            this.platos_que_puede_cocinar_cocinero.addItem(this.controller.lista_de_platos.get(index).getNombrePlato());
        }
    }
...
############################################################################################################################################################################################*/
    ...
    public void crearEInsertarCocinero(){
        ...
        Cocinero antonieta = null;
        
        antonieta = new Cocinero(this.buscarPlatoPorNombreYDevolverlo(this.platos_que_puede_cocinar_cocinero.getSelectedItem().toString()), Double.parseDouble(this.salario_cocinero.getText()), this.nombre_del_cocinero.getText(), this.especialidad_cocinero.getText(), Integer.valueOf(this.numero_de_premios.getText()));
            
        this.controller.guardarCocinero(antonieta);
        
        if(this.controller.lista_cocineros.size() == 0){
            antonieta.setIdcocinero(1);
        }else{
            antonieta.setIdcocinero(this.controller.lista_cocineros.get(this.controller.lista_cocineros.size() - 1).getIdcocinero() + 1);
        }
        
        this.modelo_cocineros.addElement(antonieta.getNombreCocinero());
        ...
        /*if(this.platos_que_puede_cocinar_cocinero.getSelectedIndex() != -1){    
            antonieta.setPlato(this.buscarPlatoPorNombreYDevolverlo(this.platos_que_puede_cocinar_cocinero.getSelectedItem().toString()));
        }else{
            antonieta.setId_del_plato_que_cocina_este_cocinero(0);
        }*/
    }
    
    public Plato buscarPlatoPorNombreYDevolverlo(String nombre_del_plato){
        
        for(int index = 0; index < this.controller.lista_de_platos.size(); index++){
            
            if(nombre_del_plato.equals(this.controller.lista_de_platos.get(index).getNombrePlato())){
                
                return this.controller.lista_de_platos.get(index);
            }
        }
...
//System.out.println("Valor del textbox de la especialidad4: " + this.espcialidad_cocinero.getText());
        ...
        this.controller.getCocineroAtPosition(this.indice_seleccionado).setEspcialidad(this.especialidad_cocinero.getText());
        this.controller.getCocineroAtPosition(this.indice_seleccionado).setNombreCocinero(this.nombre_del_cocinero.getText());
        ...
        this.controller.getCocineroAtPosition(this.indice_seleccionado).setNumeroDePremios(Integer.parseInt(this.numero_de_premios.getText()));
...
//System.out.println("Numero del plato del cocinero " + this.controller.getCocineroAtPosition(this.indice_seleccionado).getNombre() + ": " + this.controller.getCocineroAtPosition(this.indice_seleccionado).getId_del_plato_que_cocina_este_cocinero());    
        ...
        if(this.buscarPlatoPorNombreYDevolverlo(this.platos_que_puede_cocinar_cocinero.getSelectedItem().toString()).getIdplato() != -1){
            
            this.controller.getCocineroAtPosition(this.indice_seleccionado).setPlato(this.buscarPlatoPorNombreYDevolverlo(this.platos_que_puede_cocinar_cocinero.getSelectedItem().toString()));
        }else{
            this.controller.getCocineroAtPosition(this.indice_seleccionado).setPlato(new Plato());
        }
        
        this.controller.modificarCocinero( this.controller.getCocineroAtPosition(this.indice_seleccionado));
...
//System.out.println("Numero del plato del cocinero " + this.controller.getCocineroAtPosition(this.indice_seleccionado).getNombre() + ": " + this.controller.getCocineroAtPosition(this.indice_seleccionado).getId_del_plato_que_cocina_este_cocinero());    
    ...
    public Plato buscarPlatoPorIdYDevolverlo(int id){
        
        for(int index = 0; index < this.controller.lista_de_platos.size(); index++){
            
            if(this.controller.lista_de_platos.get(index).getIdplato() == id){
...
//System.out.println("Entramos en el primer condicional"); 
                this.nombre_del_cocinero.setText(this.controller.getCocineroAtPosition(index).getNombreCocinero());
                this.salario_cocinero.setText(String.valueOf(this.controller.getCocineroAtPosition(index).getSalario()));
                this.especialidad_cocinero.setText(String.valueOf(this.controller.getCocineroAtPosition(index).getEspcialidad()));
                this.numero_de_premios.setText(String.valueOf(this.controller.getCocineroAtPosition(index).getNumeroDePremios()));
                
                
                this.platos_que_puede_cocinar_cocinero.addItem(this.buscarPlatoPorIdYDevolverlo(this.controller.getCocineroAtPosition(index).getPlato().getIdplato()).getNombrePlato());
                //System.out.println("Plato que vamos a poner: " + this.buscarPlatoPorIdYDevolverlo(this.controller.getCocineroAtPosition(index).getPlato().getIdplato()).getNombrePlato());
            }
        }
    }
...
###############################################################################################################################################################################################*/
    ...
    private void borrar_cocineroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrar_cocineroActionPerformed
        ...
        this.controller.eliminarCocinero(this.controller.lista_cocineros.get(this.indice_seleccionado));
 ...
 /*                                                                        MÉTODOS DE MODIFICACIÓN DE LAS ÁREAS DE INSERCIÓN                                                                      */
    ...
    public void agregarPlatosAModelo(){
        ...
        for(int index = 0; index < this.controller.lista_de_platos.size(); index++){
            ...
            this.modelo_platos.addElement(this.controller.getPlatoAtPosition(index).getNombrePlato());
        }
    }
    ...
    public void agregarRestaurantesACombobox(){
        ...
        for(int index = 0; index < this.controller.lista_de_restaurantes.size(); index++){
            ...
            this.restaurantes_donde_se_sirve_un_plato.addItem(this.controller.lista_de_restaurantes.get(index).getNombreRestaurante());
        }
    }
...
/*################################################################################################################################################################################################
  ...
  ###############################################################################################################################################################################################*/
    ...
    public Restaurante buscarRestaurantePorNombreYDevolverlo(String nombre_del_rest){
        
        for(int index = 0; index < this.controller.lista_de_restaurantes.size(); index++){
            
            if(nombre_del_rest.equals(this.controller.lista_de_restaurantes.get(index).getNombreRestaurante())){
                
                return this.controller.lista_de_restaurantes.get(index);
            }
        }
    ...
    public void crearEInsertarPlato(){
        ...
        york = new Plato(buscarRestaurantePorNombreYDevolverlo(this.restaurantes_donde_se_sirve_un_plato.getSelectedItem().toString()), this.nombre_del_plato.getText(), this.sabor_principal_del_plato.getText(), Integer.parseInt(this.tiempo_de_prep_del_plato.getText()), Integer.parseInt(this.num_ingredientes_plato.getText()));
        
        this.controller.guardarPlato(york);
        
        if(this.controller.lista_de_platos.size() == 0){
            york.setIdplato(1);
        }else{
            york.setIdplato(this.controller.lista_de_platos.get(this.controller.lista_de_platos.size() - 1).getIdplato() + 1);
        }
        
        this.modelo_platos.addElement(york.getNombrePlato());
    ...
    public void buscarYModificarPlato(){
        ...
        this.controller.getPlatoAtPosition(this.indice_seleccionado).setNombrePlato(this.nombre_del_plato.getText());
        this.controller.getPlatoAtPosition(this.indice_seleccionado).setSaborPrincipal(this.sabor_principal_del_plato.getText());
        this.controller.getPlatoAtPosition(this.indice_seleccionado).setTiempoDePrepEnMins(Integer.parseInt(this.tiempo_de_prep_del_plato.getText()));
        this.controller.getPlatoAtPosition(this.indice_seleccionado).setNumIngredientes(Integer.parseInt(this.num_ingredientes_plato.getText()));
        
       // if(this.buscarRestaurantePorNombreYDevolverlo(this.restaurantes_donde_se_sirve_un_plato.getSelectedItem().toString()).getIdrestaurante() != -1){
            this.controller.getPlatoAtPosition(this.indice_seleccionado).setRestaurante(this.buscarRestaurantePorNombreYDevolverlo(this.restaurantes_donde_se_sirve_un_plato.getSelectedItem().toString()));
        /*}else{
            this.controller.getPlatoAtPosition(this.indice_seleccionado).setRestaurante(new Restaurante());
        }*/
        
        this.controller.modificarPlato(this.controller.getPlatoAtPosition(this.indice_seleccionado));
    ...
    public String buscarRestaurantePorIdYDevolverSuNombre(int id){
        ...
        for(int index = 0; index < this.controller.lista_de_restaurantes.size(); index++){
            ...
            if(this.controller.lista_de_restaurantes.get(index).getIdrestaurante() == id){
                
                return this.controller.lista_de_restaurantes.get(index).getNombreRestaurante();
            }
        }
    ...
    public void seleccionarPlato(){
        ...
        for(int index = 0; index < this.controller.getPlatoListSize(); index++){
            ...
            if(index == this.lista_de_platos.getSelectedIndex()){
                ...
                this.nombre_del_plato.setText(this.controller.getPlatoAtPosition(index).getNombrePlato());
                this.sabor_principal_del_plato.setText(String.valueOf(this.controller.getPlatoAtPosition(index).getSaborPrincipal()));
                this.num_ingredientes_plato.setText(String.valueOf(this.controller.getPlatoAtPosition(index).getNumIngredientes()));
                this.tiempo_de_prep_del_plato.setText(String.valueOf(this.controller.getPlatoAtPosition(index).getTiempoDePrepEnMins()));

                for(int index2 = 0; index2 < this.controller.getRestauranteListSize(); index2++){
                    
                    if(this.controller.lista_de_restaurantes.get(index2).getIdrestaurante() == this.controller.getPlatoAtPosition(index).getRestaurante().getIdrestaurante()){
//System.out.println("ID del restaurante donde se srive este plato: " + this.controller.lista_de_restaurantes.get(index2).getId_restaurante() + " y su nombre " + this.controller.lista_de_restaurantes.get(index2).getNombre_restaurante());    
                        this.restaurantes_donde_se_sirve_un_plato.addItem(this.controller.lista_de_restaurantes.get(index2).getNombreRestaurante());
 ...
 /*################################################################################################################################################################################################
  ...
  ###############################################################################################################################################################################################*/
    ...
    private void borrar_platoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrar_platoActionPerformed
        ...
        this.controller.eliminarPlato(this.controller.lista_de_platos.get(this.indice_seleccionado));
 ...
 /*                                                                        MÉTODOS DE MODIFICACIÓN DE LAS ÁREAS DE INSERCIÓN                                                                      */
    ...
    public void agregarRestaurantesAModelo(){
        ...
        for(int index = 0; index < this.controller.lista_de_restaurantes.size(); index++){
            ...
            this.modelo_restaurantes.addElement(this.controller.getRestauranteAtPosition(index).getNombreRestaurante());
        }
    }
    ...
    public void agregarClientesACombobox(){
        ...
        for(int index = 0; index < this.controller.lista_de_clientes.size(); index++){
            ...
            this.clientes_que_pagan_en_restaurante.addItem(this.controller.lista_de_clientes.get(index).getNombreCliente());
...
/*################################################################################################################################################################################################
  ...
  ###############################################################################################################################################################################################*/
    ...
    public void crearEInsertarRestaurante(){
        ...
        Restaurante ArmandoAlPantheon = null;
        
        ArmandoAlPantheon = new Restaurante(this.buscarClientePorNombreYDevolverlo(this.clientes_que_pagan_en_restaurante.getSelectedItem().toString()), this.nombre_del_restaurante.getText(), this.direccion_del_restaurante.getText(), this.aforo_maximo.getText(), Integer.parseInt(this.numero_de_empleados.getText()));
        
        this.controller.guardarRestaurante(ArmandoAlPantheon);
        
        if(this.controller.lista_de_restaurantes.size() == 0){
            ArmandoAlPantheon.setIdrestaurante(1);
        }else{
            ArmandoAlPantheon.setIdrestaurante(this.controller.lista_de_restaurantes.get(this.controller.lista_de_restaurantes.size() - 1).getIdrestaurante() + 1);
        }
        
        this.modelo_restaurantes.addElement(ArmandoAlPantheon.getNombreRestaurante());
    ...
    public Cliente buscarClientePorNombreYDevolverlo(String nombre_del_cliente){
        
        
        
        for(int index = 0; index < this.controller.lista_de_clientes.size(); index++){
            
            if(nombre_del_cliente.equals(this.controller.lista_de_clientes.get(index).getNombreCliente())){
                //System.out.println("DEBUG FUERTE2: " + nombre_del_cliente + "/" + this.controller.lista_de_clientes.get(index).getNombreCliente());
                
                return this.controller.lista_de_clientes.get(index);
            }
        }
    ...
    public void buscarYModificarRestaurante(){
        ...
        this.controller.getRestauranteAtPosition(this.indice_seleccionado).setNombreRestaurante(this.nombre_del_restaurante.getText());
        this.controller.getRestauranteAtPosition(this.indice_seleccionado).setDireccionRestaurante(this.direccion_del_restaurante.getText());
        this.controller.getRestauranteAtPosition(this.indice_seleccionado).setAforoMaximoRestaurante(this.aforo_maximo.getText());
        this.controller.getRestauranteAtPosition(this.indice_seleccionado).setNumeroEmpleadosRestaurante(Integer.parseInt(this.numero_de_empleados.getText()));
        
        //System.out.println("DEBUG FUERTE: " + this.buscarClientePorNombreYDevolverlo(this.clientes_que_pagan_en_restaurante.getSelectedItem().toString()).getIdCliente());
        //if(this.buscarClientePorNombreYDevolverlo(this.clientes_que_pagan_en_restaurante.getSelectedItem().toString()).getIdCliente().intValue() != -1){
        this.controller.getRestauranteAtPosition(this.indice_seleccionado).setCliente(this.buscarClientePorNombreYDevolverlo(this.clientes_que_pagan_en_restaurante.getSelectedItem().toString()));
        /*}else{
            this.controller.getRestauranteAtPosition(this.indice_seleccionado).setCliente(new Cliente());
        }*/
        
        this.controller.modificarRestaurante(this.controller.getRestauranteAtPosition(this.indice_seleccionado));
...
//System.out.println("DEUBG: nombre del plato: " + this.controller.getPlatoAtPosition(index).getNombre_plato());
            if(this.lista_de_restaurantes.getSelectedIndex() == index){
                ...
                this.nombre_del_restaurante.setText(this.controller.getRestauranteAtPosition(index).getNombreRestaurante());
                this.direccion_del_restaurante.setText(this.controller.getRestauranteAtPosition(index).getDireccionRestaurante());
                this.aforo_maximo.setText(String.valueOf(this.controller.getRestauranteAtPosition(index).getAforoMaximoRestaurante()));
                this.numero_de_empleados.setText(String.valueOf(this.controller.getRestauranteAtPosition(index).getNumeroEmpleadosRestaurante()));

//System.out.println("I del cliente del restaurante:" + this.controller.getRestauranteAtPosition(index).getCliente().getIdCliente());

                for(int index2 = 0; index2 < this.controller.getClienteListSize(); index2++){
                    
                    if(this.controller.lista_de_clientes.get(index2).getIdCliente() == this.controller.getRestauranteAtPosition(index).getCliente().getIdCliente()){
                        //System.out.println("ID del restaurante donde se srive este plato: " + this.controller.lista_de_restaurantes.get(index2).getIdrestaurante() + " y su nombre " + this.controller.lista_de_restaurantes.get(index2).getNombreRestaurante());    
                        this.clientes_que_pagan_en_restaurante.addItem(this.controller.lista_de_clientes.get(index2).getNombreCliente());
                        //this.clientes_que_pagan_en_restaurante.addItem(this.buscarClientePorNombreYDevolverlo(this.controller.getRestauranteAtPosition(index).getCliente().getNombreCliente()).getNombreCliente());
//System.out.println("Hemos puesto un restaurante a un plato que not enia restaurante");
                    }
                }
            }
 ...
 /*################################################################################################################################################################################################
  ...
  ###############################################################################################################################################################################################*/
    ...
    private void borrar_restauranteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrar_restauranteActionPerformed
        ...
        this.controller.eliminarRestaurante(this.controller.lista_de_restaurantes.get(this.indice_seleccionado));
 ...
 /*                                                                        MÉTODOS DE MODIFICACIÓN DE LAS ÁREAS DE INSERCIÓN                                                                      */
    ...
    public void agregarClientesAModelo(){
        ...
        for(int index = 0; index < this.controller.lista_de_clientes.size(); index++){
            ...
            this.modelo_clientes.addElement(this.controller.lista_de_clientes.get(index).getNombreCliente());
        }
    }
...
/*################################################################################################################################################################################################
  ...
  ###############################################################################################################################################################################################*/
    ...
    public void crearEInsertarCliente(){
        ...
        Cliente AlbertoChicote = null;
        
        
        AlbertoChicote = new Cliente(this.nombre_del_cliente.getText(), this.reserva_cliente.getSelectedItem().toString(), this.alergio_cliente.getSelectedItem().toString(), Integer.parseInt(this.coste_de_la_comida.getText()));
        
        this.controller.guardarCliente(AlbertoChicote);
        
        if(this.controller.lista_de_clientes.size() == 0){
            AlbertoChicote.setIdCliente(1);
        }else{
            AlbertoChicote.setIdCliente(this.controller.lista_de_clientes.get(this.controller.lista_de_clientes.size() - 1).getIdCliente() + 1);
        }
        
        this.modelo_clientes.addElement(AlbertoChicote.getNombreCliente());
    ...
    public void buscarYModificarCliente(){
        ...
        this.controller.getClienteAtPosition(this.indice_seleccionado).setNombreCliente(this.nombre_del_cliente.getText());
        ...
        this.controller.getClienteAtPosition(this.indice_seleccionado).setCosteDeLaComida(Integer.parseInt(this.coste_de_la_comida.getText()));

        this.controller.modificarCliente(this.controller.getClienteAtPosition(this.indice_seleccionado));
    ...
    public void seleccionarCliente(){
        ...
        for(int index = 0; index < this.controller.getClienteListSize(); index++){
            ...
            if(this.indice_seleccionado == index){
                ...
                this.nombre_del_cliente.setText(this.controller.getClienteAtPosition(index).getNombreCliente());
                ...
                this.coste_de_la_comida.setText(String.valueOf(this.controller.getClienteAtPosition(index).getCosteDeLaComida()));
 ...
 /*################################################################################################################################################################################################
  ...
  ###############################################################################################################################################################################################*/    
    ...
    private void borrar_clienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrar_clienteActionPerformed
        ...
        this.controller.eliminarCliente(this.controller.lista_de_clientes.get(this.indice_seleccionado));
