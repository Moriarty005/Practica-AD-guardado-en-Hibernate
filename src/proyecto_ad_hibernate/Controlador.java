...
public final class Controlador {
    ...
    public int buscarPlatiIdPorNombre(String nombre){
        ...
        for(int index = 0; index < this.lista_de_platos.size(); index++){
            ...
            if(this.lista_de_platos.get(index).getNombrePlato().equals(nombre)){
                return this.lista_de_platos.get(index).getIdplato();
            }
        }
    ...
    public void guardarCliente(Cliente jose){
       ...
       // Cliente jose = new Cliente("jose", "sí", "sí", 34);
    ...
    public void guardarCocinero(Cocinero cocinero){
    ...
    public void guardarClientes(){
        ...
        for(int index = 0; index < this.lista_de_clientes.size(); index++){
            ...
            this.guardarCliente(this.lista_de_clientes.get(index));
        }
    }
    
    public void guardarRestaurantes(){
        
        for(int index = 0; index < this.lista_de_restaurantes.size(); index++){
            
            this.guardarRestaurante(this.lista_de_restaurantes.get(index));
        }
    }
    ...
    public void guardarPlatos(){
        ...
        for(int index = 0; index < this.lista_de_platos.size(); index++){
            ...
            this.guardarPlato(this.lista_de_platos.get(index));
        }
    }
    
    public void guardarCocineros(){
        
        for(int index = 0; index < this.lista_cocineros.size(); index++){
            
            this.guardarCocinero(this.lista_cocineros.get(index));
        }
    }
    
    public void guardarEnDB(){
        this.guardarClientes();
        this.guardarRestaurantes();
        this.guardarPlatos();
        this.guardarCocineros();
    }
    
    public void modificarCliente(Cliente jose){
    ...
    public void modificarCocinero(Cocinero cocinero){
    ...
    public void eliminarCliente(Cliente jose){
        Transaction t = null; 
        try { 
            Configuration cfg = new Configuration().configure();
            SessionFactory factory = cfg.buildSessionFactory();
    ...
    public void cogerInfoClientesFromDB(){
        ...
        try{
            ...
            SessionFactory factory = cfg.buildSessionFactory();
            Session s = factory.openSession();
            Query q = (Query) s.createQuery( "FROM Cliente WHERE idcliente > 0" ); 

            List<Cliente> listaClientes  = s.createQuery( "FROM Cliente WHERE idcliente > 0" ).list();
            for (Cliente auxCliente: listaClientes) { 

                this.lista_de_clientes.add(auxCliente);
            }
    ...
    public void cogerInfoPlatosFromDB(){
        ...
        try{
            ...
            SessionFactory factory = cfg.buildSessionFactory();
            Session s = factory.openSession();
            Query q = (Query) s.createQuery( "FROM Plato WHERE idplato > 0" ); 

            List<Plato> listaPlatos  = s.createQuery( "FROM Plato WHERE idplato > 0" ).list();
            for (Plato auxPlato: listaPlatos) { 

                this.lista_de_platos.add(auxPlato);
            }
    ...
    public void cogerInfoRestaurantesFromDB(){
        ...
        try{
            ...
            SessionFactory factory = cfg.buildSessionFactory();
            Session s = factory.openSession();
            Query q = (Query) s.createQuery( "FROM Restaurante WHERE idrestaurante > 0" ); 

            List<Restaurante> listaRestaurantes  = s.createQuery( "FROM Restaurante WHERE idrestaurante > 0" ).list();
            for (Restaurante auxRestaurante: listaRestaurantes) { 

                this.lista_de_restaurantes.add(auxRestaurante);
            }
    ...
    public void cogerInfoCocinerosFromDB(){
        ...
        try{
            ...
            SessionFactory factory = cfg.buildSessionFactory();
            Session s = factory.openSession();
            Query q = (Query) s.createQuery( "FROM Cocinero WHERE idcocinero > 0" ); 

            List<Cocinero> listaCocineros  = s.createQuery( "FROM Cocinero WHERE idcocinero > 0" ).list();
            for (Cocinero auxCocinero: listaCocineros) { 

                this.lista_cocineros.add(auxCocinero);
            }
    ...
    public void recogerTodaLaInfo(){
        this.cogerInfoClientesFromDB();
        this.cogerInfoRestaurantesFromDB();
        this.cogerInfoPlatosFromDB();
        this.cogerInfoCocinerosFromDB();
    }
    
    public void prueba(){
        
        System.out.println("Entramos en el crear cosas de prueba");
        
        Cliente jose = new Cliente("jose", "si", "si", 1);
        //Restaurante res = new Restaurante(jose, "qwe", "qe", "aerqe", 1);
        //Plato p = new Plato(res, "jghj", "jfhj", 23, 65);
       // Cocinero c = new Cocinero(p, 1500.0, "juan", "sffg", 1);
       jose.setIdCliente(0);
